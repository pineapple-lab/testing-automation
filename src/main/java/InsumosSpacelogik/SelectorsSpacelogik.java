...
public class SelectorsSpacelogik extends VariablesSpacelogik {
    ...
    public static final String NACCOUNT_COMPANY_INDUSTRY_SELECT = ".national-account-modal-container > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > .d-flex:nth-of-type(2) .MuiInputBase-root input";
    ...
    public static final String NACCOUNT_COMPANY_STATE_SELECT = ".national-account-modal-container > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > .d-flex:nth-of-type(3) > .w-100:nth-of-type(1) input";
    public static final String NACCOUNT_COMPANY_STATE_OPTION = ".MuiPopover-root ul > li:nth-of-type(1)";
    public static final String NACCOUNT_COMPANY_CITY_SELECT = ".national-account-modal-container > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > .d-flex:nth-of-type(3) > .w-100:nth-of-type(2) input";
    public static final String NACCOUNT_COMPANY_CITY_OPTION = ".MuiPopover-root ul > li:nth-of-type(1)";
    public static final String NACCOUNT_COMPANY_ZIPCODE_SELECT = ".national-account-modal-container > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > .d-flex:nth-of-type(3) > .w-100:nth-of-type(3) input";
    ...
    public static final String NACCOUNT_TENANT_SALUTATION_SELECT = ".national-account-modal-container > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(2) > .d-flex-column > div > .d-flex:nth-of-type(3) > .generic-select-container input";
