...
public class AdvancedSettingPracticeInvite extends InterfaceElements{
    private volatile boolean isRunning = true;
    Label labelTypeContent = new Label ("Practice id");
    ...
    public AdvancedSettingPracticeInvite(String executionDetailsAvanzadas , String seleccionAvanzada){
    ...
    public void start(Stage stageJoin) {
        stageJoin.setTitle("Configuraciones practice invites");
        ...
        tfTypeContent.setPromptText("Introducir id de la practica");
        ...
        settingAdvancedExecute.setOnAction(e->{
            Thread execute=  new Thread (()->{
                VariablesDocola.practiceId = parseInt(tfTypeContent.getText());
                iActions.actionNewRegisterInvitationInPractice();
