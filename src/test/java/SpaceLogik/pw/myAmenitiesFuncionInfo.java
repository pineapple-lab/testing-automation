...
public class myAmenitiesFuncionInfo extends robotBaseSpaceLogik {
    @Test
   public void validacionInfoMyAmenitiesHealtClub(){
       login();
    ...
    @Test
    public void validacionInfoMyAmenitiesFoodService(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesConferenceFacility(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesTenantLounge(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesConvenienceStore(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesVendingArea(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesHotelLodging(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesBikeRoom(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesBankingAtm(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesDryCleaner(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesHairsalonBarber(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesConcierge(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesMannedSecurity(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
    ...
    @Test
    public void validacionInfoMyAmenitiesDayCare(){
        login();
        page.click("text=MY LOGIK");
        page.click("text = My Amenities");
