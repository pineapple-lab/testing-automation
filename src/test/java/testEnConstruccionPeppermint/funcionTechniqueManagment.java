...
public class funcionTechniqueManagment extends robotBasePeppermint {
    ...
    public void createTechnique(){
        ...
        page.waitForNavigation(()->{
            Path pathVideoPath = Paths.get(pathVideo);
            ...
            kb.press("ArrowDown");
            kb.press("Enter");
            page.click("app-movement-form >div>div>div>div:nth-of-type(3) #category");
            kb.press("ArrowDown");
            kb.press("Enter");
            page.click("app-movement-form >div>div>div>div:nth-of-type(3) #topic");
            kb.press("ArrowDown");
            kb.press("Enter");
            page.pause();
            page.click("app-movement-form >div>div>div>div:nth-of-type(3) #subTopic");
            kb.press("ArrowDown");
            kb.press("Enter");
