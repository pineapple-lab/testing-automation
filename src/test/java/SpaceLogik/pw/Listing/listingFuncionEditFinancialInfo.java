...
public class listingFuncionEditFinancialInfo extends robotBaseSpaceLogik {
    @Test
    public void validacionEditFinancialInfoRateUnaSuite(){
        login();
    ...
    @Test
    public void validacionEditFinancialInfoAbatementUnaSuite(){
        login();
        navegarAListingFinancialInfo();
    ...
    @Test
    public void validacionEditFinancialInfoComissionUnaSuite(){
        login();
        navegarAListingFinancialInfo();
    ...
    @Test
    public void validacionEditFinancialInfoConstructionUnaSuite(){
        login();
        navegarAListingFinancialInfo();
    ...
    @Test
    public void validacionEditMultipleSuites(){
        login();
        navegarAListingFinancialInfo();
        editarListingFinancialInfoRateUnaSuite();
        editarListingFinancialInfoAbatementUnaSuite();
